...
#ifdef FN_ALLOC_STRING
int FN_ALLOC_STRING(const char *szValue);
#endif // FN_ALLOC_STRING
...
#ifdef FN_ALLOC_STRING_Post
int FN_ALLOC_STRING_Post(const char *szValue);
#endif // FN_ALLOC_STRING_Post
